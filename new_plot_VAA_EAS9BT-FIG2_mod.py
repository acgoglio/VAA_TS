...
# === Read data ===
# Mod FC_w10_20191110
time_bt, bt = read_nc_series('ISMAR_TG_mod_EAS9BT_FC_w10_bdy_1.nc','sossheig') #) ('ISMAR_TG_mod_EAS9BT_FC_w10.nc', 'sossheig') # WRONG!!!
...
# Tmp
#time_tides_eas9_1,tides_eas9_1 = filter_time(time_an9, an9, start_time, end_time) 
#time_tides_eas9_2,tides_eas9_2 =filter_time(time_an9nt,an9nt,start_time, end_time)
#tpxo = tides_eas9_1 - tides_eas9_2
#time_tpxo = time_tides_eas9_1
...
for offset_type in range (3):
   ...
   if offset_type == 0 :
      ...
      mod_meanbt       = 0.027481  #0.2318    # Nov 2019 Mean at ISMAR_TG
   ...
   #ax.plot(time_btnt, btnt, color='lime',linewidth=1, label=f'MedFS BT without tides forecast (12 November peak = {int(peak_btnt)} cm)')
