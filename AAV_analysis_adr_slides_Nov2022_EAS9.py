...
mpl.use('Agg')
#
workdir='/work/cmcc/ag15419/VAA_paper_EAS9/VAA_EAS9_long/' 
outfile=open(workdir+'bandwidths.txt',"w")
coo_file='AAV_adr_2022.coo'
model_bathy='/work/cmcc/ag15419/VAA_paper_EAS9/DATA0/bathy_meter.nc'
...
#   mod_nontidal3_sealevel = mod_nontidal3 - np.nanmean(mod_nontidal3) + obs_ref
   ...
   try:
      plt.plot(alltimes[-528:],mod_tidal2_sealevel[-528:], '-', color='tab:green',label = 'EAS9 MedFS forecast (22 November peak: '+str(peak_mod_tidal2)+' cm)',linewidth=3)
      ...
      try:
         plt.plot(alltimes[-128:],mod_tidal2_sealevel[-128:], '-', color='tab:blue',label = 'EAS9 MedFS forecast (22 November peak: '+str(peak_mod_tidal2)+' cm)',linewidth=3)
         ...
         plt.plot(alltimes[-72:],mod_tidal2_sealevel[-72:], '-', color='tab:blue',label = 'EAS9 MedFS forecast (22 November peak: '+str(peak_mod_tidal2)+' cm)',linewidth=3)
...
#   plt.ylim([-15,15])
   ...
   #plt.title (' Sea Level at '+STG)
   plt.title ('Sea Level observations and MedFS forecast at ISMAR_TG')
...
#   mod_nontidal_sealevel=mod_nontidal_sealevel[-72:]+tpxo_tid[-72:]-np.nanmean(mod_nontidal_sealevel[-72:]+tpxo_tid[-72:])+np.nanmean(obs_ismar_sealevel[-72:])
   ...
   #plt.plot(alltimes[-72:-48],mod_tidal1_sealevel[-72:-48], '-', color=colors[1],label = 'MEDFS Analysis',linewidth=3)
   #plt.plot(alltimes[-49:],mod_tidal1_sealevel[-49:], '-', color=colors[2],label = ' (max: '+str(peak_mod_tidal1)+' cm)',linewidth=3)
   plt.plot(alltimes_obs[-72:],obs_ismar_sealevel[-72:], '-o', color='navy',label = 'Hourly OBS (22 November peak: '+str(peak_obs_ismar)+' cm)',linewidth=3)
   plt.plot(alltimes[-72:],mod_tidal2_sealevel[-72:], '-', color='tab:green',label = 'EAS9 MedFS forecast (22 November peak: '+str(peak_mod_tidal2)+' cm)',linewidth=3)
   #plt.plot(alltimes[-72:],mod_nontidal_sealevel[-72:]+tpxo_tid[-72:], '-', color='tab:orange',label = 'EAS9-NT+TPXO (max: '+str(peak_mod_nontidal)+' cm)',linewidth=3)
   #plt.plot(alltimes[-72:],mod_nontidal_sealevel[-72:], '-', color='tab:orange',label = 'EAS9-NT+TPXO (max: '+str(peak_mod_nontidal)+' cm)',linewidth=3)
   #plt.plot(alltimes[-72:],mod_tidal3_sealevel[-72:], '-', color='tab:green',label = 'EAS9-simu (max: '+str(peak_mod_tidal3)+' cm)',linewidth=3)
   ...
   # Add Extreme flood line +140 cm
   plt.axhline(140,color='red',linewidth=2,label='Extreme floods threshold (140 cm)')
   plt.axhline(obs_ref,color='black',linewidth=1,label='Mean OBS ('+str(int(obs_ref))+' cm)')
   ...
   plt.ylim([-50,200])
   plt.xlabel ('Days of November 2022')
