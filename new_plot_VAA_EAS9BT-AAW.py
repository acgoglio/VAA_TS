...
for offset_type in range (8):
   ...
   #ax.plot(time_bt, bt, color='lime',linewidth=3, label=f'EAS9-BT MedFS forecast (12 November peak = {int(peak_bt)} cm)')
   ...
   ax.set_ylabel('Sea Level [cm]', fontsize=20)
   ax.set_xlabel('Days of November 2019', fontsize=20)
   ax.set_title('Sea Level observations and MedFS forecast near Venice', fontsize=20)
