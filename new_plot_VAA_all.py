...
time_btnt, btnt = read_nc_series('ISMAR_TG_mod_EAS9BTNT_FC_w10_lbc.nc', 'sossheig')
...
time_bc9_w08, bc9_w08 = read_nc_series('ISMAR_TG_mod_EAS9_FC_w08.nc', 'sossheig')
time_nt, nt = read_nc_series('ISMAR_TG_mod_EAS9-NT_FC_w10.nc', 'sossheig')
time_nt_w08, nt_w08 = read_nc_series('ISMAR_TG_mod_EAS9-NT_FC_w08.nc', 'sossheig')
...
time_anbtnt,anbtnt = read_nc_series('ISMAR_TG_mod_EAS9BTNT_AN_w10_lbc.nc','sossheig','time_counter')
time_an9nt,an9nt = read_nc_series('ISMAR_TG_mod_EAS9-NT_AN_w10.nc','sossheig','time_counter')
time_an9_w08,an9_w08 = read_nc_series('ISMAR_TG_mod_EAS9_AN_w08.nc','sossheig','time_counter')
time_an9nt_w08,an9nt_w08 = read_nc_series('ISMAR_TG_mod_EAS9-NT_AN_w08.nc','sossheig','time_counter')
...
time_bc9_w08, bc9_w08 = filter_time(time_bc9_w08, bc9_w08, start_time, end_time)
...
time_nt, nt = filter_time(time_nt, nt, start_time, end_time)
time_nt_w08, nt_w08 = filter_time(time_nt_w08, nt_w08, start_time, end_time)
...
time_an9_w08, an9_w08 = filter_time(time_an9_w08, an9_w08, start_time, end_time)
time_an9nt_w08, an9nt_w08 = filter_time(time_an9nt_w08, an9nt_w08, start_time, end_time)
...
peak_bc9_w08 = np.nanmax(bc9_w08)
peak_obs_hourly = np.nanmax(obs_hourly)
peak_obs_hf = np.nanmax(obs_hf)
peak_an9 = np.nanmax(an9)
peak_an9nt = np.nanmax(an9nt)
peak_anbtnt = np.nanmax(anbtnt)
peak_an9_w08 = np.nanmax(an9_w08)
peak_an9nt_w08 = np.nanmax(an9nt_w08)
peak_nt = np.nanmax(nt)
peak_nt_w08 = np.nanmax(nt_w08)
...
mean_bc9_w08    = np.nanmean(bc9_w08)
...
mean_an9_w08    = np.nanmean(an9_w08)
mean_an9nt_w08  = np.nanmean(an9nt_w08)
mean_nt         = np.nanmean(nt)
mean_nt_w08     = np.nanmean(nt_w08)
...
ax.plot(time_bc9_w08, bc9_w08, color='gold', linewidth=1.5, label=f'EAS9 MedFS forecast w08 (12 November peak = {int(peak_bc9_w08)} cm, mean ={int(mean_bc9_w08)} cm)')
...
ax.plot(time_btnt, btnt, color='pink', linewidth=1.5, label=f'EAS9BTNT MedFS forecast (12 November peak = {int(peak_btnt)} cm, mean ={int(mean_btnt)} cm)')
ax.plot(time_an9, an9, color='cyan', linewidth=1.5, label=f'EAS9 MedFS analysis (12 November peak = {int(peak_an9)} cm, mean ={int(mean_an9)} cm)')
ax.plot(time_nt, nt, color='red', linewidth=1.5, label=f'EAS9-NT MedFS forecast (12 November peak = {int(peak_nt)} cm, mean ={int(mean_nt)} cm)')
ax.plot(time_nt_w08, nt_w08, color='coral', linewidth=1.5, label=f'EAS9-NT MedFS forecast w08 (12 November peak = {int(peak_nt_w08)} cm, mean ={int(mean_nt_w08)} cm)')
ax.plot(time_an9nt, an9nt, color='blue', linewidth=1.5, label=f'EAS9-NT MedFS analysis (12 November peak = {int(peak_an9nt)} cm, mean ={int(mean_an9nt)} cm)')
ax.plot(time_anbtnt, anbtnt, color='purple', linewidth=1.5, label=f'EAS9-BT-NT MedFS hyndcast (12 November peak = {int(peak_anbtnt)} cm, mean ={int(mean_anbtnt)} cm)')
ax.plot(time_an9_w08, an9_w08, color='black', linewidth=1.5, label=f'EAS9 MedFS analysis w08 (12 November peak = {int(peak_an9_w08)} cm, mean ={int(mean_an9_w08)} cm)')
ax.plot(time_an9nt_w08, an9nt_w08, color='gray', linewidth=1.5, label=f'EAS9-NT MedFS analysis w08 (12 November peak = {int(peak_an9nt_w08)} cm, mean ={int(mean_an9nt_w08)} cm)')
...
nt_or=nt
an9nt_or=an9nt
an9nt_w08_or=an9nt_w08
time_bt_or=time_bt
time_btnt_or=time_btnt
time_bc_or=time_bc
time_bc9_or=time_bc9
time_bc9_w08_or=time_bc9_w08
time_an9_or=time_an9
time_an9_w08_or=time_an9_w08
time_nt_or=time_nt
time_nt_w08_or=time_nt_w08
time_an9nt_or=time_an9nt
time_an9nt_w08_or=time_an9nt_w08
...
for offset_type in range (8):
 if offset_type == 2:
   ...
   an9nt=an9nt_or
   an9_w08=an9_w08_or
   an9nt_w08=an9nt_w08_or
   time_bt=time_bt_or
   time_btnt=time_btnt_or
   time_bc=time_bc_or
   time_bc9=time_bc9_or
   time_bc9_w08=time_bc9_w08_or
   time_nt=time_nt_or
   time_nt_w08=time_nt_w08_or
   time_an9nt=time_an9nt_or
   time_an9nt_w08=time_an9nt_w08_or
   ...
   if offset_type == 0 :
      ...
      bc9_w08 = bc9_w08 - bc9_w08[0] + mean_4_offset
      an9 = an9 - an9[0] + mean_4_offset
      an9_w08 = an9_w08 - an9_w08[0] + mean_4_offset
      ...
      bc9_w08 = bc9_w08 - np.nanmean(bc9_w08) + mean_4_offset
      an9 = an9 - np.nanmean(an9) + mean_4_offset
      an9_w08 = an9_w08 - np.nanmean(an9_w08) + mean_4_offset
      obs_hourly = obs_hourly 
      obs_hf = obs_hf 
      tpxo = tpxo - np.nanmean(tpxo) + mean_4_offset
      ...
      mod_meannt       = -0.12458  # Nov 2019 Mean at ISMAR_TG
      #mod_meanbtnt     = 0.24292   # Nov 2019 Mean at ISMAR_TG
      mod_meannt_w08   = -0.12470  # Nov 2019 Mean at ISMAR_TG
      mod_mean9_w08    = -0.12654  # Nov 2019 Mean at ISMAR_TG
      mod_meanbtnt     = 0.029473  # Nov 2019 Mean at ISMAR_TG
      ...
      mod_meanbtnt   = mod_meanbtnt*100
      mod_mean9      = mod_mean9*100  
      mod_mean9_w08  = mod_mean9_w08*100
      mod_meannt     = mod_meannt*100
      mod_meannt_w08 = mod_meannt_w08*100
      ...
      bc9_w08 = bc9_w08 - mod_mean9_w08 + mean_4_offset
      nt  = nt - mod_meannt + mean_4_offset
      nt_w08  = nt_w08 - mod_meannt_w08 + mean_4_offset
      #an9 = an9 - np.nanmean(an9) + mean_4_offset
      #an9nt = an9nt - np.nanmean(an9nt) + mean_4_offset
      an9 = an9 - mod_mean9 + mean_4_offset
      an9_w08 = an9_w08 - mod_mean9_w08 + mean_4_offset
      an9nt = an9nt - mod_meannt + mean_4_offset
      anbtnt = anbtnt - mod_meanbtnt + mean_4_offset
      an9nt_w08 = an9nt_w08 - mod_meannt + mean_4_offset
      obs_hourly = obs_hourly
      obs_hf = obs_hf
      tpxo = tpxo - np.nanmean(tpxo) + mean_4_offset
      ...
      an9 = an9 - np.nanmean(an9) + mean_4_offset
      an9_w08 = an9_w08 - np.nanmean(an9_w08) + mean_4_offset
      nt = nt - np.nanmean(nt) + mean_4_offset
      an9nt = an9nt - np.nanmean(an9nt) + mean_4_offset
      an9nt_w08 = an9nt_w08 - np.nanmean(an9nt_w08) + mean_4_offset
      obs_hourly = obs_hourly
      obs_hf = obs_hf
      tpxo = tpxo - np.nanmean(tpxo) + mean_4_offset
   ...
   peak_an9nt_w08 = np.nanmax(an9nt_w08)
   print ('Peaks:')
   print ('peak_bt',peak_bt)
   print ('peak_btnt',peak_btnt)
   print ('peak_bc',peak_bc)
   print ('peak_bc9',peak_bc9)
   print ('peak_bc9_w08',peak_bc9_w08)
   print ('peak_an9',peak_an9)
   print ('peak_obs_hourly',peak_obs_hourly)
   print ('peak_an9nt',peak_an9nt)
   print ('peak_anbtnt',peak_anbtnt)
   print ('peak_nt',peak_nt)
   print ('peak_nt_w08',peak_nt_w08)

   fig, ax = plt.subplots(figsize=(12, 8))
   plt.rc('font', size=20)
   
   # Time series
   ax.plot(time_bc, bc, color='tab:green', linewidth=1.5, label=f'EAS6 MedFS forecast (12 November peak = {int(peak_bc)} cm)')
   ax.plot(time_bc9, bc9, color='tab:orange', linewidth=1.5, label=f'EAS9 MedFS forecast (12 November peak = {int(peak_bc9)} cm)')
   ax.plot(time_bc9_w08, bc9_w08, color='gold', linewidth=1.5, label=f'EAS9 MedFS forecast w08 (12 November peak = {int(peak_bc9_w08)} cm)')
   ax.plot(time_an9, an9, color='cyan', linewidth=1.5, label=f'EAS9 MedFS analysis (12 November peak = {int(peak_an9)} cm)')
   ax.plot(time_anbtnt, anbtnt, color='purple', linewidth=1.5, label=f'EAS9-BT-NT MedFS hyndcast (12 November peak = {int(peak_anbtnt)} cm, mean ={int(mean_anbtnt)} cm)')
   ax.plot(time_an9_w08, an9_w08, color='black', linewidth=1.5, label=f'EAS9 MedFS analysis w08 (12 November peak = {int(peak_an9_w08)} cm)')
   ax.plot(time_bt, bt, color='magenta', linewidth=1.5, label=f'EAS9-BT MedFS forecast (12 November peak = {int(peak_bt)} cm)')
   ax.plot(time_btnt, btnt, color='pink', linewidth=1.5, label=f'EAS9BTNT MedFS forecast (12 November peak = {int(peak_btnt)} cm)')
   #ax.plot(time_obs_hf, obs_hf, 'b--', linewidth=2, label=f'10 min freq. OBS (12 November peak = {int(peak_obs_hf)} cm)')
   ...
   #ax.plot(time_tpxo, tpxo, 'k--', label='Tides TPXO9')
   ax.plot(time_nt, nt, color='red', linewidth=1.5, label=f'EAS9-NT MedFS forecast (12 November peak = {int(peak_nt)} cm)')
   ax.plot(time_nt_w08, nt_w08, color='coral', linewidth=1.5, label=f'EAS9-NT MedFS forecast w08 (12 November peak = {int(peak_nt_w08)} cm)')
   ax.plot(time_an9nt, an9nt, color='blue', linewidth=1.5, label=f'EAS9-NT MedFS analysis (12 November peak = {int(peak_an9nt)} cm)')   
   ax.plot(time_an9nt_w08, an9nt_w08, color='gray', linewidth=1.5, label=f'EAS9-NT MedFS analysis w08 (12 November peak = {int(peak_an9nt_w08)} cm)')
